...
<html lang="en">
  <head>
    ...
    <title>Registro Trasportador</title>
...
<div class="container">
  <br>
      <div class="form-group">
        <label class="COMUNES1textobienvenida1" for=""><b>Para transportar productos necesita una cuenta</b></label><br>
...
<form class="" action="index.html" method="post">
 ...
 <div class="row">
  ...
  <div class="row">
     ...
     <div class="col-xs-4 col-sm-6">
       <div class="ESTILOS1lineabajacampotexto">
       <input class="form-control" type="text" name=tipovehiculo placeholder="Tipo de vehículo">
     </div>
     </div>
  </div>
  <br>
  <div class="row">
      ...
      <div class="col-xs-4 col-sm-6">
        <div class="ESTILOS1lineabajacampotexto">
        <input class="form-control" type="text" name=capacidad placeholder="Capacidad">
      </div>
      </div>
  </div>
  <br>
  <div class="row">
       ...
       <div class="col-xs-4 col-sm-6">
         <div class="ESTILOS1lineabajacampotexto">
         <input class="form-control" type="text" name=confirmacion placeholder="Confirme la clave">
       </div>
       </div>
  </div>
  <br>
  ...
  <div class="container">
    <div class="row">
          ...
          <div class="col-xs-3 col-sm-2">
              <button type="button" class="ESTILOS1botones" name="cancelar">CANCELAR</button>
          </div>
          <div class="col-xs-3 col-sm-2">
