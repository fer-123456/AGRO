...
<div class="container">
  <div class="row">
      <div class="col-3">
            ...
            <label class="COMUNES1textobienvenida5" for="">Recuerde que para vender, comprar o transportar sus productos  debe ingresar a su cuenta con su número de teléfono y su clave personal</label>
            </div>
            </div>
      <div class="col-3">
      </div>
  ...
  <div class="row">
        ...
        <div class="col-3">
          <div class="ESTILOS1centrado">
            <a class="COMUNES1links1" href="?menu=P_Registro_Transportista">Crear Cuenta</a>
          </div>
        </div>
        <div class="col-3">
          <div class="ESTILOS1centrado">
