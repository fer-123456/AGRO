  ...
  <div class="container">
    <div class="row">
          <div class="col-xs-2 col-sm-6 col-md-6" >
            ...
            location.href = "?menu=C_Login_productor";
            };
         </script>
          </div>
          <div class="col-xs-2 col-sm-6 col-md-6">
              <button type="button" class="ESTILOS2botones10" name="quierocrearcuenta"id="registro_productor">QUIERO CREAR UNA CUENTA Y COMENZAR</button>
              <script type="text/javascript">
            document.getElementById("registro_productor").onclick = function () {
            location.href = "?menu=P_Registro_Productor";
            };
            </script>
          </div>
    </div>
