...
<input class="form-control"  type="text" name=cuanto placeholder="¿Cúanto va a vender?">
</div>
</div>
<div class="col-xs-4 col-sm-6">
<div class="ESTILOS1lineabajacampotexto">
<select class="form-control" name="peso">
     <option disabled selected>¿Cómo va a venderlo?</option>
     <option>Kg</option>
     <option>Bulto</option>
...
<div class="col-xs-4 col-sm-6">
<div class="ESTILOS1lineabajacampotexto">
<input class="form-control"  type="password" name=Precio placeholder="¿Cúal es el precio?">
</div>
</div>
<div class="col-xs-4 col-sm-6">
<div class="ESTILOS1lineabajacampotexto">
...
<div class="col-xs-4 col-sm-6">
 <div class="ESTILOS1lineabajacampotexto">
 <input type="date" class="form-control" >¿Cúando se cosecho?</imput>
</div>
</div>
<div class="col-xs-4 col-sm-6">
 <div class="ESTILOS1lineabajacampotexto">
 <input type="date" class="form-control" >¿Cúando se vence?</imput>
</div>
</div>
</div>
<br>
...
<div class="ESTILOS1lineabajacampotexto">
<select class="form-control" name="peso">
     <option disabled selected>Calidad</option>
     <option>Extra</option>
     <option>Alta</option>
     <option>Media</option>
     <option>Baja</option>
...
<div class="row">
      ...
      <div class="col-xs-3 col-sm-2">
         ...
         <script type="text/javascript">
           ...
           location.href = "?menu=formulario2_producto";
           };
         </script>
      </div>
</div>
